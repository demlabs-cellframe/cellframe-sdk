...
typedef enum cf_sdk_modules {
    ...
    CF_MODULE_CONSENSUS_CHIPCHAIN = 0x00000020,
    CF_MODULE_CONSENSUS_NONE      = 0x00000040,
    CF_MODULE_NETWORK             = 0x00000080,
    CF_MODULE_WALLET              = 0x00000100,
    CF_MODULE_WALLET_CACHE        = 0x00000200,
    CF_MODULE_SRV_XCHANGE         = 0x00000400,
    CF_MODULE_SRV_VOTING          = 0x00000800,
    CF_MODULE_SRV_BRIDGE          = 0x00001000,
    CF_MODULE_SRV_STAKE           = 0x00002000,
    CF_MODULE_SRV_STAKE_EXT       = 0x00004000,
    CF_MODULE_CLI                 = 0x00008000,
    CF_MODULE_MEMPOOL             = 0x00010000,
    ...
    CF_MODULE_ALL_CONSENSUS = CF_MODULE_CONSENSUS_DAG | CF_MODULE_CONSENSUS_POA |
                              ...
                              CF_MODULE_CONSENSUS_CHIPCHAIN | CF_MODULE_CONSENSUS_NONE,
