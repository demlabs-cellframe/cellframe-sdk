...
if(UNIX)
    ...
    if (ANDROID)
        set(_CCOPT "-DDAP_DEBUG ${CFLAGS_WARNINGS} -g3 -ggdb -fno-eliminate-unused-debug-symbols -fno-strict-aliasing")
        message ("CCOPTS ${_CCOPT}")
...
if(WIN32)
    ...
    include_directories(3rdparty/mman/)
