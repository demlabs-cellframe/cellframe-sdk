...
if(UNIX)
    ...
    if (APPLE)
        ...
        set(DARWIN ON)
        set(BSD ON)
        if (${_CMAKE_OSX_SYSROOT_PATH} MATCHES "iOS"  OR ${PLATFORM} MATCHES "IOS")
            message("IOS detected")
            set(IOS ON)
            add_definitions("-DDAP_OS_IOS")
        elseif (${_CMAKE_OSX_SYSROOT_PATH} MATCHES "MacOS")
            message("MacOS detected, CMAKE_SYSTEM_NAME=${CMAKE_SYSTEM_NAME}")
            set(MACOS ON)
