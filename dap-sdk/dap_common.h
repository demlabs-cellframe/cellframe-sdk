...
void    _log_it_ext (const char *a_rtn_name, unsigned a_line_no, enum dap_log_level, const char * format, ... );
void    _dump_it    (const char *a_rtn_name, unsigned a_line_no, const char *a_var_name, const void *src, unsigned short srclen);
