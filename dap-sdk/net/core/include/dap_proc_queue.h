...
{
    return dap_proc_queue_add_callback_ext(a_worker, a_callback, a_callback_arg, DAP_QUE$K_PRI_NORMAL);
}
...
{
    return dap_proc_queue_add_callback_inter_ext(a_es_input, a_callback, a_callback_arg, DAP_QUE$K_PRI_NORMAL);
}
