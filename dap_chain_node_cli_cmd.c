...
int com_tx_wallet(int argc, char ** argv, char **str_reply)
{
    ...
    int arg_index = 1, cmd_num = CMD_NONE;
    ...
    dap_chain_node_addr_t address = {0};
    ...
    case CMD_WALLET_NEW: {
        ...
        l_wallet = dap_chain_wallet_create_with_seed_ext (l_wallet_name, c_wallets_path, l_sign_type, l_seed, l_seed_size, l_pass_str);
