...
json_object *dap_chain_policy_list(dap_chain_net_id_t a_net_id)
{
    ...
    json_object_object_add(l_ret, "cumulative_active", json_object_new_string(l_active_str->str));
    ...
    json_object_object_add(l_ret, "conditional_active", json_object_new_string(l_active_str->str));
    json_object_object_add(l_ret, "conditional_inactive", json_object_new_string(l_inactive_str->str));
