...
typedef dap_json_t *(*dap_chain_callback_atom_to_json)(dap_json_t **a_arr_out, dap_chain_t *a_chain, dap_chain_atom_ptr_t a_atom, size_t a_atom_size, const char *a_hex_out_type);
