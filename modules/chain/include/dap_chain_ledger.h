...
typedef bool (* dap_chain_ledger_verificator_callback_out_t)(dap_chain_datum_tx_t *a_tx, dap_chain_tx_out_cond_t *a_cond);
...
//Init all verificators
bool 	dap_chain_ledger_verificators_init(void);
