...
typedef int (*dap_chain_srv_callback_event_verify_t)(dap_chain_net_id_t a_net_id, const char *a_event_group_name, int a_event_type,
                                                     void *a_event_data, size_t a_event_data_size, dap_hash_sha3_256_t *a_event_tx_hash);
...
typedef dap_json_t * (*dap_chain_srv_callback_get_fee)(dap_chain_net_id_t a_net_id);
...
int dap_chain_srv_event_verify(dap_chain_net_id_t a_net_id, dap_chain_srv_uid_t a_srv_uid, const char *a_event_group_name, int a_event_type, void *a_event_data, size_t a_event_data_size, dap_hash_sha3_256_t *a_event_tx_hash);
