...
void dap_ledger_test_excess_supply(dap_ledger_t *a_ledger, dap_cert_t *a_cert, dap_chain_addr_t *a_addr){
    ...
    dap_assert_PIF(!dap_ledger_token_add(a_ledger, (byte_t *)l_decl, l_decl_size, dap_time_now()), "Adding token declaration to ledger.");
...
//        l_offset += l_tsd_size_a;
        ...
        dap_assert_PIF(!dap_ledger_token_add(a_ledger, (byte_t *)l_decl, l_decl_size, dap_time_now()),
...
void dap_ledger_test_run(void){
    ...
    dap_assert_PIF(!dap_ledger_token_add(l_ledger, (byte_t *)l_token_decl, l_token_decl_size, dap_time_now()), "Adding token declaration to ledger.");
    ...
    dap_assert_PIF(!dap_ledger_token_add(l_ledger, (byte_t *)l_token_decl_for_update, l_token_decl_for_update_size, dap_time_now()), "Adding token declaration to ledger.");
    {
        ...
        dap_assert_PIF(
                dap_ledger_token_add(l_ledger, (byte_t *) l_token_upd_smaller_value, l_token_upd_smaller_value_size, dap_time_now()),
    ...
    }
    {
        ...
        dap_assert_PIF(
                !dap_ledger_token_add(l_ledger, (byte_t *) l_token_upd_more_value, l_token_upd_more_value_size, dap_time_now()),
    ...
    }
    {
        ...
        dap_assert_PIF(
                !dap_ledger_token_add(l_ledger, (byte_t *) l_token_upd_zero_value, l_token_upd_zero_value_size, dap_time_now()),
