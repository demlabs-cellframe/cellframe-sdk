...
// Datum operations
typedef dap_chain_datum_t * (*dap_chain_callback_datum_find_by_hash_t)(dap_chain_t *, dap_hash_sha3_256_t *, dap_hash_sha3_256_t *, int *);
...
typedef uint256_t (*dap_chain_callback_calc_reward)(dap_chain_t *a_chain, dap_hash_sha3_256_t *a_block_hash, dap_pkey_t *a_block_sign_pkey);
