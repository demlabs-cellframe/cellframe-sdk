 ...
 */
void dap_chain_tx_compose_register_rpc(const char *a_net_name, const char *a_url, uint16_t a_port);
...
dap_chain_tx_compose_config_t* dap_chain_tx_compose_config_init(const char *a_net_name, const char *a_url_str, uint16_t a_port, const char *a_cert_path);
...
dap_json_t* dap_tx_create_xchange_compose(const char *l_net_str, const char *l_token_sell, const char *l_token_buy, 
...
dap_json_t* dap_cli_hold_compose(const char *a_net_name, const char *a_chain_id_str, const char *a_ticker_str, 
...
dap_json_t* dap_cli_xchange_order_remove_compose(const char *l_net_str, const char *l_order_hash_str, const char *l_fee_str, 
...
dap_chain_datum_tx_t* dap_stake_unlock_datum_create_compose(dap_chain_addr_t *a_wallet_addr, dap_hash_fast_t *a_stake_tx_hash, 
                                                           ...
                                                           uint256_t a_delegated_value, dap_chain_tx_compose_config_t *a_config);
