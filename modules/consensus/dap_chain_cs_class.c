...
typedef struct dap_chain_cs_callbacks_item {
    ...
    dap_chain_cs_old_callbacks_t callbacks;
    UT_hash_handle hh;
} dap_chain_cs_old_callbacks_item_t;
...
static dap_chain_cs_old_callbacks_item_t *s_cs_callbacks = NULL;
...
{
    dap_chain_cs_old_callbacks_item_t *l_item = NULL;
...
{
    dap_chain_cs_old_callbacks_item_t *l_item = DAP_NEW_Z_RET_IF_FAIL(dap_chain_cs_old_callbacks_item_t);
    dap_strncpy(l_item->name, a_cs_str, sizeof (l_item->name));
    l_item->callbacks = a_callbacks;
