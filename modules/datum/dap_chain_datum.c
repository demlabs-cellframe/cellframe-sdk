...
void dap_datum_token_dump_tsd_to_json(dap_json_t * json_obj_out, dap_chain_datum_token_t *a_token, size_t a_token_size, const char *a_hash_out_type)
{
    ...
    if (!l_tsd_begin) {
        dap_json_object_add(json_obj_out, "status", dap_json_object_new_string("<CORRUPTED TSD SECTION>"));
        return;
    }
    ...
    dap_tsd_iter(l_tsd, l_tsd_size, l_tsd_begin, l_tsd_total_size) {
        ...
        case DAP_CHAIN_DATUM_TOKEN_TSD_TYPE_TOTAL_SIGNS_VALID: {
            uint16_t l_t = 0;
            dap_json_object_add(json_obj_out, "total_signs_valid", dap_json_object_new_int(_dap_tsd_get_scalar(l_tsd, &l_t)));
            continue;
        }
        case DAP_CHAIN_DATUM_TOKEN_TSD_TYPE_TOTAL_PKEYS_ADD:
            if(l_tsd->size >= sizeof(dap_pkey_t)) {
                    ...
                    dap_json_object_add(json_obj_out, "total_pkeys_add_with_wrong_size", dap_json_object_new_int(l_tsd->size));
            continue;
        case DAP_CHAIN_DATUM_TOKEN_TSD_TYPE_TOTAL_PKEYS_REMOVE:
            if(l_tsd->size == sizeof(dap_chain_hash_fast_t) ){
                    ...
                    dap_json_object_add(json_obj_out, "total_pkeys_remove_with_wrong_size", dap_json_object_new_int(l_tsd->size));
            continue;
        ...
        default: {
                ...
                dap_json_object_add(json_obj_out, "tsd_size", dap_json_object_new_int(l_tsd->size));
            }
        }
    }
}
                             ...
                             dap_chain_net_id_t a_net_id)
{
    ...
    l_is_first ? 
    dap_json_object_add(json_obj_out, "first_transaction", dap_json_object_new_string("emit")):
    dap_json_object_add(json_obj_out, "first_transaction", dap_json_object_new_string(""));
    dap_json_object_add(json_obj_out, "hash", dap_json_object_new_string(l_hash_str));
    dap_json_object_add(json_obj_out, "tx_created", dap_json_object_new_string(l_tmp_buf));
    dap_json_object_add(json_obj_out, "token_ticker", a_ticker ? dap_json_object_new_string(a_ticker) : dap_json_object_new_string(""));
    ...
    TX_ITEM_ITER_TX(item, l_size, a_datum) {
        ...
        case TX_ITEM_TYPE_IN:
            ...
            l_hash_str = !dap_hash_fast_is_blank(&l_hash_tmp)
                ...
                : "BLANK";
            dap_json_object_add(json_obj_item,"item_type", dap_json_object_new_string("IN"));
            dap_json_object_add(json_obj_item,"tx_prev_hash", dap_json_object_new_string(l_hash_str));
            dap_json_object_add(json_obj_item,"tx_out_prev_idx", dap_json_object_new_uint64(((dap_chain_tx_in_t*)item)->header.tx_out_prev_idx));
            break;
        case TX_ITEM_TYPE_OUT_OLD: {
            const char *l_value_str = dap_uint256_to_char(
                dap_chain_uint256_from(((dap_chain_tx_out_old_t*)item)->header.value), NULL );
            dap_json_object_add(json_obj_item,"item_type", dap_json_object_new_string("OUT OLD"));
            dap_json_object_add(json_obj_item,"value", dap_json_object_new_string(l_value_str));
            dap_json_object_add(json_obj_item,"address", dap_json_object_new_string(dap_chain_addr_to_str_static(&((dap_chain_tx_out_old_t*)item)->addr)));
        } break;
        case TX_ITEM_TYPE_OUT: { // 256
            ...
            dap_json_object_add(json_obj_item,"item_type", dap_json_object_new_string("OUT"));
            dap_json_object_add(json_obj_item,"coins", dap_json_object_new_string(l_coins_str));
            dap_json_object_add(json_obj_item,"value", dap_json_object_new_string(l_value_str));
            dap_json_object_add(json_obj_item,"address", dap_json_object_new_string(l_addr_str));            
        } break;
        case TX_ITEM_TYPE_IN_EMS: {
            ...
            dap_json_object_add(json_obj_item,"item_type", dap_json_object_new_string("IN_EMS"));
        ...
        case TX_ITEM_TYPE_IN_REWARD: {
            ...
            l_hash_str = dap_strcmp(a_hash_out_type, "hex")
                    ? dap_enc_base58_encode_hash_to_str_static(&l_hash_tmp)
                    : dap_chain_hash_fast_to_str_static(&l_hash_tmp);
            dap_json_object_add(json_obj_item,"item_type", dap_json_object_new_string("IN_REWARD"));
        ...
        case TX_ITEM_TYPE_SIG: {
            ...
            dap_json_object_add(json_obj_item,"item_type", dap_json_object_new_string("SIG"));
            ...
            dap_json_object_add(json_obj_item,"sender_addr", dap_json_object_new_string(dap_chain_addr_to_str_static(&l_sender_addr)));            
        } break;
        case TX_ITEM_TYPE_RECEIPT: {
            ...
            dap_json_object_add(json_obj_item,"item_type", dap_json_object_new_string("RECEIPT"));
            dap_json_object_add(json_obj_item,"size", dap_json_object_new_uint64(((dap_chain_datum_tx_receipt_t*)item)->size));
            dap_json_object_add(json_obj_item,"ext_size", dap_json_object_new_uint64(((dap_chain_datum_tx_receipt_t*)item)->exts_size));
            ...
            dap_json_object_add(json_obj_item,"units_type", dap_json_object_new_string(dap_chain_srv_unit_enum_to_str(((dap_chain_datum_tx_receipt_t*)item)->receipt_info.units_type.enm)));
            dap_json_object_add(json_obj_item,"coins", dap_json_object_new_string(l_coins_str));
            dap_json_object_add(json_obj_item,"value", dap_json_object_new_string(l_value_str));
            ...
            case (sizeof(dap_sign_t) * 2): {
                ...
                dap_json_object_add(json_obj_item,"sign_inf", dap_json_object_new_string("client"));
            ...
            case (sizeof(dap_sign_t)): {
                ...
                dap_json_object_add(json_obj_item,"sign_inf", dap_json_object_new_string("provider"));
        ...
        case TX_ITEM_TYPE_PKEY: {
            ...
            dap_json_object_add(json_obj_item,"item_type", dap_json_object_new_string("PKey"));
            dap_json_object_add(json_obj_item,"pkey", dap_json_object_new_string(""));
            dap_json_object_add(json_obj_item,"key", dap_json_object_new_string(""));
            dap_json_object_add(json_obj_item,"type", dap_json_object_new_string(dap_pkey_type_to_str(l_pkey->header.type)));
            dap_json_object_add(json_obj_item,"size", dap_json_object_new_uint64(l_pkey->header.size));
            dap_json_object_add(json_obj_item,"hash", dap_json_object_new_string(l_hash_str));

        } break;
        case TX_ITEM_TYPE_TSD: {
            dap_json_object_add(json_obj_item,"item_type", dap_json_object_new_string("TSD data"));
            dap_json_object_add(json_obj_item,"type", dap_json_object_new_uint64(((dap_chain_tx_tsd_t*)item)->header.type));
            dap_json_object_add(json_obj_item,"size", dap_json_object_new_uint64(((dap_chain_tx_tsd_t*)item)->header.size));            
        } break;
        case TX_ITEM_TYPE_IN_COND:
            dap_json_object_add(json_obj_item,"item_type", dap_json_object_new_string("IN COND"));
            l_hash_tmp = ((dap_chain_tx_in_cond_t*)item)->header.tx_prev_hash;
            l_hash_str = dap_strcmp(a_hash_out_type, "hex")
                    ? dap_enc_base58_encode_hash_to_str_static(&l_hash_tmp)
                    : dap_chain_hash_fast_to_str_static(&l_hash_tmp);
            dap_json_object_add(json_obj_item,"receipt_idx", dap_json_object_new_int(((dap_chain_tx_in_cond_t*)item)->header.receipt_idx));
            dap_json_object_add(json_obj_item,"tx_prev_hash", dap_json_object_new_string(l_hash_str));
            dap_json_object_add(json_obj_item,"tx_out_prev_idx", dap_json_object_new_uint64(((dap_chain_tx_in_cond_t*)item)->header.tx_out_prev_idx));
            break;
        case TX_ITEM_TYPE_OUT_COND: {
            char l_tmp_buff[70];
            dap_json_object_add(json_obj_item,"item_type", dap_json_object_new_string("OUT COND"));
            ...
            switch (((dap_chain_tx_out_cond_t*)item)->header.subtype) {
                case DAP_CHAIN_TX_OUT_COND_SUBTYPE_SRV_PAY: {
                    ...
                    dap_json_object_add(json_obj_item,"max_price_coins", dap_json_object_new_string(l_coins_str));
                    dap_json_object_add(json_obj_item,"max_price_value", dap_json_object_new_string(l_value_str));
                ...
                case DAP_CHAIN_TX_OUT_COND_SUBTYPE_SRV_STAKE_POS_DELEGATE: {
                    ...
                    l_hash_str = dap_strcmp(a_hash_out_type, "hex")
                            ? dap_enc_base58_encode_hash_to_str_static(&l_hash_tmp)
                            : dap_chain_hash_fast_to_str_static(&l_hash_tmp);
                    dap_json_object_add(json_obj_item,"signing_addr", dap_json_object_new_string(dap_chain_addr_to_str_static(l_signing_addr)));
                    dap_json_object_add(json_obj_item,"with pkey hash", dap_json_object_new_string(l_hash_str));                    
                    snprintf(l_tmp_buff, sizeof(l_tmp_buff), ""NODE_ADDR_FP_STR"",NODE_ADDR_FP_ARGS(l_signer_node_addr));
                    dap_json_object_add(json_obj_item,"signer_node_addr", dap_json_object_new_string(l_tmp_buff));
                ...
                case DAP_CHAIN_TX_OUT_COND_SUBTYPE_SRV_XCHANGE: {
                    ...
                    dap_json_object_add(json_obj_item,"net_id", dap_json_object_new_string(l_tmp_buff));
        ...
        case TX_ITEM_TYPE_OUT_EXT: {
            ...
            dap_json_object_add(json_obj_item,"item_type", dap_json_object_new_string("OUT EXT"));
        ...
        case TX_ITEM_TYPE_VOTING:{
            ...
            dap_json_object_add(json_obj_item,"item_type", dap_json_object_new_string("VOTING"));
            dap_json_object_add(json_obj_item,"voting_question", dap_json_object_new_string(l_voting_params->question));
            dap_json_object_add(json_obj_item,"answer_options", dap_json_object_new_string(""));
            ...
            if (l_voting_params->voting_expire) {
                ...
                dap_json_object_add(json_obj_item,"voting_expire", dap_json_object_new_string(l_tmp_buf));                
            }
            if (l_voting_params->votes_max_count) {
                dap_json_object_add(json_obj_item, "votes_max_count", dap_json_object_new_uint64(l_voting_params->votes_max_count));
            }
            dap_json_object_add(json_obj_item,"changing_vote_is", l_voting_params->vote_changing_allowed ? dap_json_object_new_string("available") : 
                                    dap_json_object_new_string("not available"));
            l_voting_params->delegate_key_required ? 
                dap_json_object_add(json_obj_item,"delegated_key_for_participating_in_voting", dap_json_object_new_string("required")):
                dap_json_object_add(json_obj_item,"delegated_key_for_participating_in_voting", dap_json_object_new_string("not required"));                 
        ...
        case TX_ITEM_TYPE_VOTE:{
            ...
            dap_json_object_add(json_obj_item,"item_type", dap_json_object_new_string("VOTE"));
            dap_json_object_add(json_obj_item,"voting_hash", dap_json_object_new_string(l_hash_str));
            dap_json_object_add(json_obj_item,"vote_answer_idx", dap_json_object_new_uint64(l_vote_item->answer_idx));

        } break;
        default:
            dap_json_object_add(json_obj_item,"item_type", dap_json_object_new_string("This transaction have unknown item type"));
            break;
        }
        dap_json_array_add(json_arr_items, json_obj_item);
    }
    dap_json_object_add(json_obj_out, "ITEMS", json_arr_items);
    return true;
}

void s_token_dump_decl_json(dap_json_t  *a_obj_out, dap_chain_datum_token_t *a_token, size_t a_token_size, const char *a_hash_out_type) {
    dap_json_object_add(a_obj_out,"type",dap_json_object_new_string("DECL"));
    switch (a_token->subtype) {
        case DAP_CHAIN_DATUM_TOKEN_SUBTYPE_PRIVATE:{
            ...
            dap_json_object_add(a_obj_out,"auth_signs_valid",dap_json_object_new_uint64(a_token->signs_valid));
            dap_json_object_add(a_obj_out,"auth_signs_total",dap_json_object_new_uint64(a_token->signs_total));
...
void s_token_dump_update_json(dap_json_t  *a_obj_out, dap_chain_datum_token_t *a_token, size_t a_token_size, const char *a_hash_out_type, bool a_verbose) {
    if (a_verbose) dap_json_object_add(a_obj_out,"type",dap_json_object_new_string("UPDATE"));
    switch (a_token->subtype) {
        case DAP_CHAIN_DATUM_TOKEN_SUBTYPE_PRIVATE: {
            if (a_verbose) dap_json_object_add(a_obj_out,"subtype",dap_json_object_new_string("PRIVATE"));
            dap_json_object_add(a_obj_out,"total_sign",dap_json_object_new_uint64(a_token->signs_total));
...
void dap_chain_datum_dump_json(dap_json_t* a_json_arr_reply, dap_json_t  *a_obj_out, dap_chain_datum_t *a_datum, const char *a_hash_out_type, dap_chain_net_id_t a_net_id, bool a_verbose)
{
    ...
    switch (a_datum->header.type_id) {
        case DAP_CHAIN_DATUM_TOKEN: {
            ...
            dap_json_object_add(json_obj_datum,"version",dap_json_object_new_int(l_token->version));
            ...
            switch (l_token->type) {
                ...
                break;
                default:
                    dap_json_object_add(json_obj_datum,"type", dap_json_object_new_string("UNKNOWN"));
                    break;
            }
            if (l_token->subtype == DAP_CHAIN_DATUM_TOKEN_SUBTYPE_SIMPLE ) {
                ...
                dap_json_object_add(json_obj_datum,"sign_total", dap_json_object_new_uint64(l_token->signs_total));
                dap_json_object_add(json_obj_datum,"sign_valid", dap_json_object_new_uint64(l_token->signs_valid));
        ...
        case DAP_CHAIN_DATUM_TOKEN_EMISSION: {
            ...
            dap_json_object_add(json_obj_datum,"emission_hash", dap_json_object_new_string(l_hash_str));
            ...
            dap_json_object_add(json_obj_datum,"to_addr", dap_json_object_new_string(dap_chain_addr_to_str_static(&(l_emission->hdr.address))));

            switch (l_emission->hdr.type) {
            case DAP_CHAIN_DATUM_TOKEN_EMISSION_TYPE_AUTH:
                dap_json_object_add(json_obj_datum,"signs_count", dap_json_object_new_uint64(l_emission->data.type_auth.signs_count));
        ...
        case DAP_CHAIN_DATUM_ANCHOR:{
            ...
            dap_json_object_add(json_obj_datum,"type_datum",dap_json_object_new_string("=== Datum anchor ==="));
            dap_json_object_add(json_obj_datum,"hash",dap_json_object_new_string(l_hash_str));
            ...
            dap_json_object_add(json_obj_datum,"decree_hash",dap_json_object_new_string(l_hash_str));
    ...
    dap_json_object_add(a_obj_out,"datum",json_obj_datum);  
}
