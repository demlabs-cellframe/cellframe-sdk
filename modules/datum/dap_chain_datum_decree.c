...
void dap_chain_datum_decree_dump_json(dap_json_t *a_json_out, dap_chain_datum_decree_t *a_decree, size_t a_decree_size, const char *a_hash_out_type)
{
    char *l_type_str;
...
void dap_chain_datum_decree_certs_dump_json(dap_json_t * a_json_out, byte_t * a_signs, size_t a_certs_size, const char *a_hash_out_type)
{
    if (!a_certs_size) {
