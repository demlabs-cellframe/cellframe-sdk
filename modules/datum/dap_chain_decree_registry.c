...
void dap_chain_decree_registry_deinit(void)
{
    ...
    dap_ht_foreach_hh(hh, s_decree_handlers, l_entry, l_tmp) {
    ...
    const char *a_handler_name)
{
    ...
    dap_ht_find_hh(hh, s_decree_handlers, &l_key, sizeof(uint32_t), l_existing);
    ...
    dap_ht_add_hh(hh, s_decree_handlers, key, l_entry);
    ...
    uint16_t a_decree_subtype)
{
    ...
    dap_ht_find_hh(hh, s_decree_handlers, &l_key, sizeof(uint32_t), l_entry);
