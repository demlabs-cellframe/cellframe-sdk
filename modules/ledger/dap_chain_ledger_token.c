                                                       ...
                                                       dap_global_db_obj_t *a_values, void *a_arg)
{
    ...
    for (size_t i = 0; i < a_values_count; i++) {
        ...
        dap_ht_add_hh(hh, l_token_item->token_emissions, datum_token_emission_hash, l_emission_item);
    }
                      ...
                      dap_hash_sha3_256_t *a_token_update_hash)
{
    ...
    if (l_token_item) {
        ...
        dap_ht_find_hh(hh, l_token_item->token_ts_updated, &l_token_update_hash, sizeof(dap_hash_sha3_256_t), l_token_update_item);
...
#undef CLEAN_UP
        ...
        *l_token_update_item = (dap_ledger_token_update_item_t) {
        ...
        dap_ht_add_hh(hh, l_token_item->token_ts_updated, update_token_hash, l_token_update_item);
        pthread_rwlock_unlock(&l_token_item->token_ts_updated_rwlock);
                         ...
                         dap_chain_datum_token_emission_t **a_emission, dap_ledger_token_item_t **a_token_item)
{
    ...
    dap_ht_find_hh(hh, l_token_item->token_emissions, a_emission_hash, sizeof(*a_emission_hash), l_token_emission_item);
...
int dap_ledger_token_emission_add(dap_ledger_t *a_ledger, byte_t *a_token_emission, size_t a_token_emission_size, dap_hash_sha3_256_t *a_emission_hash)
{
    ...
    dap_ht_add_hh(hh, l_token_item->token_emissions, datum_token_emission_hash, l_token_emission_item);
                                         ...
                                         size_t a_token_emission_size, dap_hash_sha3_256_t *a_token_emission_hash)
{
    if (a_ledger->load_mode) {
        ...
        pthread_rwlock_rdlock(&PVT(a_ledger)->tokens_rwlock);
        dap_ht_foreach_hh(hh, PVT(a_ledger)->tokens, l_token_item, l_item_tmp) {
            pthread_rwlock_rdlock(&l_token_item->token_emissions_rwlock);
            dap_ht_find_hh(hh, l_token_item->token_emissions, a_token_emission_hash, sizeof(*a_token_emission_hash),
                ...
                const char *a_token_ticker, const dap_hash_sha3_256_t *a_token_emission_hash, dap_ledger_token_item_t **a_token_item)
{
    ...
    dap_ledger_token_emission_item_t *l_token_emission_item = NULL;
    pthread_rwlock_rdlock(&l_token_item->token_emissions_rwlock);
    dap_ht_find_hh(hh, l_token_item->token_emissions, a_token_emission_hash, sizeof(*a_token_emission_hash), l_token_emission_item);
    pthread_rwlock_unlock(&l_token_item->token_emissions_rwlock);
...
dap_json_t *dap_ledger_token_info(dap_ledger_t *a_ledger, size_t a_limit, size_t a_offset, int a_version)
{
    ...
    size_t i = 0;
    dap_ht_foreach_hh(hh, PVT(a_ledger)->tokens, l_token_item, l_tmp_item) {
        if (i < l_arr_start) {
            i++;
            continue;
        }
        ...
        char *** a_tickers, size_t * a_tickers_size)
{
    if (a_addr == NULL){ // Get all tockens
        ...
        if (l_count && a_tickers){
            ...
            l_count = 0;
            dap_ht_foreach_hh(hh, PVT(a_ledger)->tokens, l_token_item, l_tmp) {
        ...
        if(l_count && a_tickers){
            ...
            dap_ht_foreach_hh(hh, PVT(a_ledger)->balance_accounts, wallet_balance, tmp) {
...
int dap_ledger_token_emissions_mark_hardfork(dap_ledger_t *a_ledger, dap_time_t a_hardfork_time)
{
    ...
    dap_ht_foreach_hh(hh, PVT(a_ledger)->tokens, l_token_item, l_token_tmp) {
        ...
        dap_ht_foreach_hh(hh, l_token_item->token_emissions, l_emission, l_emission_tmp) {
