...
static void s_set_reply_text_node_status_json(dap_chain_net_t *a_net, json_object *a_json_out) {
    ...
    if (dap_chain_policy_activated(1, a_net->pub.id.uint64)) {
        json_object_object_add(a_json_out, "policy1", json_object_new_string("\n"
            "        ▓▓▓▓▓▓▓            ▒▒▒▒▒▒\n"
            "      ▓▓▒▒▒▒▒▒▒▓▓        ▒▒░░░░░░▒▒\n"
            "    ▓▓▒▒▒▒▒▒▒▒▒▒▒▓▓    ▒▒░░░░░░░░░▒▒▒\n"
            "   ▓▓▒▒▒▒▒▒▒▒▒▒▒▒▒▒▓▓▒▒░░░░░░░░░░░░░░▒\n"
    ...
    if (dap_chain_policy_activated(3, a_net->pub.id.uint64)) {
        json_object_object_add(a_json_out, "policy3", json_object_new_string("\n"
            "░░░░░░▄█▀█▄░░░░░░░░░░░░░░░\n"
            "░▄█▀▀▀▀░░░░▀█▄▄▄▄▄▄▄░░░░░░\n"
            "█▀░░░░░░░░░░░░░░░░░▀█░░░░░\n"
            "▀▄░▄░░░░░░░░░░░░░░░▄█░░░░░\n"
    ...
    if (dap_chain_policy_activated(7, a_net->pub.id.uint64)) {
        json_object_object_add(a_json_out, "policy7", json_object_new_string("\n"
"                      8¶8\n"
"                       $¶¶8\n"
"                        $¶¶¶\n"
"                         8¶¶¶$\n"
