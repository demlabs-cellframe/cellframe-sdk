...
static bool s_json_get_int64(struct dap_json_t *a_json, const char *a_key, int64_t *a_out)
{
                                        ...
                                        dap_chain_datum_tx_t** a_out_tx, size_t* a_items_count, size_t *a_items_ready)
{
    ...
    if(a_net){
        l_list = l_in_list;
        while(l_list) {
            struct dap_json_t *l_json_item_obj = (struct dap_json_t*) l_list->data;
...
int dap_chain_net_tx_to_json(dap_chain_datum_tx_t *a_tx, dap_json_t *a_out_json)
{
    ...
    dap_json_t* json_arr_items = json_object_new_array();
