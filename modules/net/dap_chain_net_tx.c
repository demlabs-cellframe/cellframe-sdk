                                        ...
                                        dap_chain_datum_tx_t** a_out_tx, size_t* a_items_count, size_t *a_items_ready)
{
        ...
        for(size_t i = 0; i < l_items_count; ++i) {
            ...
            switch (l_item_type) {
                case TX_ITEM_TYPE_IN: {
                    ...
                    bool l_is_out_prev_idx = dap_json_rpc_get_int64_uint64(l_json_item_obj, "out_prev_idx", &l_out_prev_idx,false);
                    // If prev_hash and out_prev_idx were read
                    if(l_prev_hash_str && l_is_out_prev_idx){
                        dap_chain_hash_fast_t l_tx_prev_hash = {};
                        if(!dap_chain_hash_fast_from_str(l_prev_hash_str, &l_tx_prev_hash)) {
    ...
    for(size_t i = 0; i < l_items_count; ++i) {
        ...
        case TX_ITEM_TYPE_EVENT: {
            ...
            if (!dap_json_rpc_get_int64_uint64(l_json_item_obj, "event_type", &l_event_type_int, false)) {
        ...
        case TX_ITEM_TYPE_IN_EMS:{
            ...
            bool l_is_chain_id = dap_json_rpc_get_int64_uint64(l_json_item_obj, "chain_id", &l_chain_id_uint, false);
        ...
        case TX_ITEM_TYPE_IN_REWARD:{
            ...
            const char *l_block_hash_str = dap_json_rpc_get_text(l_json_item_obj, "block_hash");
            bool l_is_value = s_json_get_uint256(l_json_item_obj, "value", &l_value);
            if(l_block_hash_str ) {
                dap_hash_fast_t l_block_hash;
        ...
        case TX_ITEM_TYPE_OUT_STD: {
            ...
            const char *l_json_item_addr_to_str = dap_json_rpc_get_text(l_json_item_obj, "addr_to");
            bool l_is_value = s_json_get_uint256(l_json_item_obj, "value", &l_value);
        ...
        case TX_ITEM_TYPE_OUT_COND: {
            ...
            case DAP_CHAIN_TX_OUT_COND_SUBTYPE_SRV_XCHANGE: {
                ...
                const char *l_token_buy = dap_json_rpc_get_text(l_json_item_obj, "token_buy");
                if(!l_token_buy) {
            ...
            case DAP_CHAIN_TX_OUT_COND_SUBTYPE_SRV_STAKE_POS_DELEGATE:{
                ...
                const char *l_pkey_full_str = dap_json_rpc_get_text(l_json_item_obj, "pkey_full");
        ...
        case TX_ITEM_TYPE_SIG: {
            ...
            int64_t l_sign_size = 0, l_sign_b64_strlen = strlen(l_sign_b64_str),
                    l_sign_decoded_size = DAP_ENC_BASE64_DECODE_SIZE(l_sign_b64_strlen);
            if ( !dap_json_rpc_get_int64_uint64(l_json_item_obj, "sig_size", &l_sign_size, false) )
                log_it(L_NOTICE, "Json TX: \"sig_size\" unspecified, will be calculated automatically");
        ...
        case TX_ITEM_TYPE_RECEIPT: {
            ...
            int64_t l_units = 0;
            if(!dap_json_rpc_get_int64_uint64(l_json_item_obj, "units", &l_units, false)){
                log_it(L_ERROR, "Json TX: bad units in TYPE_RECEIPT");
                break;
            }
            uint256_t l_value = { };
        ...
        case TX_ITEM_TYPE_TSD: {
            int64_t l_tsd_type = 0;
            if(!dap_json_rpc_get_int64_uint64(l_json_item_obj, "type_tsd", &l_tsd_type, false)) {
