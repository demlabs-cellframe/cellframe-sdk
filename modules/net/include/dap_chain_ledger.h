...
typedef enum dap_ledger_tx_check{
    ...
    DAP_LEDGER_TX_CACHE_CHECK_NULL_TX,
    DAP_LEDGER_TX_CACHE_CHECK_INVALID_TX_SIGN,
    DAP_LEDGER_TX_CACHE_IN_EMS_ALREADY_USED,
    DAP_LEDGER_TX_CACHE_STAKE_LOCK_IN_EMS_ALREADY_USED,
    DAP_LEDGER_TX_CACHE_CHECK_EMISSION_NOT_FOUND,
    DAP_LEDGER_TX_CACHE_CHECK_TX_NO_VALID_INPUTS,
    DAP_LEDGER_TX_CACHE_CHECK_TICKER_NOT_FOUND,
    DAP_LEDGER_TX_CACHE_STAKE_LOCK_INVALID_TOKEN,
    DAP_LEDGER_TX_CACHE_STAKE_LOCK_NO_OUT_COND_FOR_IN_EMS,
    DAP_LEDGER_TX_CACHE_MULT256_OVERFLOW_EMS_LOCKED_X_RATE,
    DAP_LEDGER_TX_CACHE_CHECK_NO_OUT_EXT_FOR_GIRDLED_IN_EMS,
    DAP_LEDGER_TX_CACHE_NO_OUT_ITEMS_FOR_BASE_TX,
    DAP_LEDGER_TX_CACHE_CHECK_TOKEN_EMS_VALUE_EXEEDS_CUR_SUPPLY,
    DAP_LEDGER_TX_CACHE_STAKE_LOCK_UNEXPECTED_VALUE,
    DAP_LEDGER_TX_CACHE_STAKE_LOCK_TICKER_NOT_FOUND,
    DAP_LEDGER_TX_CACHE_STAKE_LOCK_OTHER_TICKER_EXPECTED,
    ...
    DAP_LEDGER_TX_CACHE_VERIFICATOR_CHECK_FAILURE,
    DAP_LEDGER_TX_CACHE_CHECK_PREV_TICKER_NOT_FOUND,
...
#define DAP_CHAIN_CS_VERIFY_CODE_TX_NO_PREVIOUS  DAP_LEDGER_TX_CACHE_CHECK_PREV_TX_NOT_FOUND
// Error code for no emission for a transaction (for stay in mempoold)
#define DAP_CHAIN_CS_VERIFY_CODE_TX_NO_EMISSION  DAP_LEDGER_TX_CACHE_CHECK_EMISSION_NOT_FOUND
