...
typedef enum s_com_tx_create_json_err {
    ...
    DAP_CHAIN_NET_TX_CREATE_JSON_NOT_FOUND_NET_BY_NAME,
    DAP_CHAIN_NET_TX_CREATE_JSON_NOT_FOUND_CHAIN_BY_NAME,
    DAP_CHAIN_NET_TX_CREATE_JSON_NOT_FOUND_ARRAY_ITEMS,
