...
typedef enum s_com_err{
    ...
    DAP_CHAIN_NODE_CLI_HASH_INVALID,
    DAP_CHAIN_NODE_CLI_REQUIRE_FEE_IS_UINT256,
    DAP_CHAIN_NODE_CLI_REQUIRE_PARAMETER_FROM_WALLET_OR_FROM_EMISSION,
    DAP_CHAIN_NODE_CLI_REQUIRE_PARAMETER_FROM_EMISSION,
    DAP_CHAIN_NODE_CLI_REQUIRE_PARAMETER_FROM_CHAIN_EMISSION,
    DAP_CHAIN_NODE_CLI_REQUIRE_PARAMETER_WALLET_FEE,
    DAP_CHAIN_NODE_CLI_CERT_IS_INVALID,
    DAP_CHAIN_NODE_CLI_REQUIRE_PARAMETER_CERT_OR_WALLET_FEE,
    DAP_CHAIN_NODE_CLI_REQUIRE_TOKEN,
    DAP_CHAIN_NODE_CLI_TOKEN_NOT_DECLARATED_IN_NET,
    DAP_CHAIN_NODE_CLI_REQUIRE_PARAMETER_TO_ADDR,
    DAP_CHAIN_NODE_CLI_DESTINATION_ADDRESS_INVALID,
    DAP_CHAIN_NODE_CLI_REQUIRE_PARAMETER_VALUE_OR_INVALID_FORMAT_VALUE,
    DAP_CHAIN_NODE_CLI_NOT_FOUND_CHAIN,
    DAP_CHAIN_NODE_CLI_NO_PRIVATE_KEY_DEFINED,
    DAP_CHAIN_NODE_CLI_CAN_NOT_ADD_DATUM_IN_MEMPOOL,
    DAP_CHAIN_NODE_CLI_WALLET_DOES_NOT_EXIST,
    DAP_CHAIN_NODE_CLI_SOURCE_ADDRESS_INVALID,
    DAP_CHAIN_NODE_CLI_DESTINATION_NETWORK_IS_UNREACHEBLE,
    DAP_CHAIN_NODE_CLI_CAN_NOT_CREATE_TRANSACTION,
    DAP_CHAIN_NODE_CLI_EQ_SOURCE_DESTINATION_ADDRESS,
    DAP_CHAIN_NODE_CLI_WRONG_TIME_FORMAT
} s_com_err_t;
