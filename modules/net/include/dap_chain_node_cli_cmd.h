...
typedef enum s_com_tx_node_err{
    ...
    DAP_CHAIN_NODE_CLI_COM_NODE_HASH_REC_ERR,
    DAP_CHAIN_NODE_CLI_COM_NODE_NET_PARAM_ERR,
    DAP_CHAIN_NODE_CLI_COM_NODE_INCOMPATIBLE_PARAMS_ERR,
    DAP_CHAIN_NODE_CLI_COM_NODE_WALLET_ADDR_ERR,
    DAP_CHAIN_NODE_CLI_COM_NODE_ID_NET_ADDR_DIF_ERR,
    DAP_CHAIN_NODE_CLI_COM_NODE_ADDR_WALLET_DIF_ERR,
    DAP_CHAIN_NODE_CLI_COM_NODE_WALLET_ERR,
    DAP_CHAIN_NODE_CLI_COM_NODE_NET_ERR,
    DAP_CHAIN_NODE_CLI_COM_NODE_CHAIN_PARAM_ERR,
    DAP_CHAIN_NODE_CLI_COM_NODE_DAP_DB_HISTORY_TX_ERR,
    DAP_CHAIN_NODE_CLI_COM_NODE_DAP_DB_HISTORY_ADDR_ERR,
    DAP_CHAIN_NODE_CLI_COM_NODE_DAP_DB_HISTORY_ALL_ERR,
