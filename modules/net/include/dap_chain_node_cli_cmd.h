...
typedef enum s_com_err{
    DAP_CHAIN_NODE_CLI_OK = 0,
    DAP_CHAIN_NODE_CLI_REQUIRE_FEE,
    DAP_CHAIN_NODE_CLI_REQUIRE_NET,
    DAP_CHAIN_NODE_CLI_REQUIRE_EMISSION,
    DAP_CHAIN_NODE_CLI_REQUIRE_CHAIN,
    DAP_CHAIN_NODE_CLI_REQUIRE_CHAIN_EMISSION,
    DAP_CHAIN_NODE_CLI_REQUIRE_WALLET,
    DAP_CHAIN_NODE_CLI_REQUIRE_CERT,
    DAP_CHAIN_NODE_CLI_REQUIRE_FORCE,
    DAP_CHAIN_NODE_CLI_FEE_IS_LOW,
    DAP_CHAIN_NODE_CLI_FEE_IS_ZERO,
    DAP_CHAIN_NODE_CLI_NET_NOT_FOUND,
    DAP_CHAIN_NODE_CLI_CHAIN_NOT_FOUND,
    DAP_CHAIN_NODE_CLI_EMISSION_CHAIN_NOT_FOUND,
    DAP_CHAIN_NODE_CLI_WALLET_NOT_FOUND,
    DAP_CHAIN_NODE_CLI_CERT_NOT_FOUND,
    DAP_CHAIN_NODE_CLI_ARGUMENT_INVALID,
} s_com_err_t;

typedef enum cmd_check_flag {
    DAP_CHAIN_NODE_CLI_CHECK_NET = BIT(0),
    DAP_CHAIN_NODE_CLI_CHECK_FEE_LOW = BIT(1),
    DAP_CHAIN_NODE_CLI_CHECK_FEE_ZERO = BIT(2),
    DAP_CHAIN_NODE_CLI_CHECK_CERT = BIT(3),
    DAP_CHAIN_NODE_CLI_CHECK_WALLET = BIT(4),
    DAP_CHAIN_NODE_CLI_CHECK_WALLET_FEE = BIT(5),
    DAP_CHAIN_NODE_CLI_CHECK_FROM_WALLET = BIT(6),
    DAP_CHAIN_NODE_CLI_CHECK_EMISSION = BIT(7),
    DAP_CHAIN_NODE_CLI_CHECK_CHAIN = BIT(8),
    DAP_CHAIN_NODE_CLI_CHECK_EMISSION_CHAIN = BIT(9),
    DAP_CHAIN_NODE_CLI_CHECK_FORCE = BIT(10),
    DAP_CHAIN_NODE_CLI_CHECK_TX_NUM = BIT(11),
    DAP_CHAIN_NODE_CLI_CHECK_VALUE = BIT(12),
    DAP_CHAIN_NODE_CLI_CHECK_CHAIN_ADDR = BIT(13),
} cmd_check_flag_t;

typedef enum cmd_check_tsd {
    DAP_CHAIN_NODE_CLI_CHECK_TSD_NET = 0,  // should be always first
    DAP_CHAIN_NODE_CLI_CHECK_TSD_FEE,
    DAP_CHAIN_NODE_CLI_CHECK_TSD_VALUE,
    DAP_CHAIN_NODE_CLI_CHECK_TSD_VALUE_COUNT,
    DAP_CHAIN_NODE_CLI_CHECK_TSD_CERT,
    DAP_CHAIN_NODE_CLI_CHECK_TSD_CHAIN_ADDR,
    DAP_CHAIN_NODE_CLI_CHECK_TSD_CHAIN_ADDR_COUNT,
    DAP_CHAIN_NODE_CLI_CHECK_TSD_WALLET,
    DAP_CHAIN_NODE_CLI_CHECK_TSD_FROM_WALLET,
    DAP_CHAIN_NODE_CLI_CHECK_TSD_WALLET_FEE,
    DAP_CHAIN_NODE_CLI_CHECK_TSD_EMISSION_HASH,
    DAP_CHAIN_NODE_CLI_CHECK_TSD_CHAIN,
    DAP_CHAIN_NODE_CLI_CHECK_TSD_EMISSION_CHAIN,
    DAP_CHAIN_NODE_CLI_CHECK_TSD_FORCE,
    DAP_CHAIN_NODE_CLI_CHECK_TSD_TX_NUM,
