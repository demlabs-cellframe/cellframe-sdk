...
typedef enum s_com_token_update_err{
    ...
    DAP_CHAIN_NODE_CLI_COM_TOKEN_UPDATE_FIND_TICKER_ERR,
    DAP_CHAIN_NODE_CLI_COM_TOKEN_UPDATE_NOT_VALID_CERT_ERR,
    DAP_CHAIN_NODE_CLI_COM_TOKEN_UPDATE_TOKEN_CANNOT_MATCH,
    DAP_CHAIN_NODE_CLI_COM_TOKEN_UPDATE_CANT_CREATE_DATUM,
    DAP_CHAIN_NODE_CLI_COM_TOKEN_UPDATE_UNKNOWN_TOKEN_TYPE,
    DAP_CHAIN_NODE_CLI_COM_TOKEN_UPDATE_FAILED,
