...
typedef enum s_com_ledger_err{
    ...
    //DAP_CHAIN_NODE_CLI_COM_LEDGER_MEMORY_ERR,
    ...
    //DAP_CHAIN_NODE_CLI_COM_LEDGER_ADDR_WALLET_DIF_ERR,
    //DAP_CHAIN_NODE_CLI_COM_LEDGER_WALLET_ERR,
    //DAP_CHAIN_NODE_CLI_COM_LEDGER_NET_ERR,
    //DAP_CHAIN_NODE_CLI_COM_LEDGER_CHAIN_PARAM_ERR,
    //DAP_CHAIN_NODE_CLI_COM_LEDGER_DAP_DB_HISTORY_TX_ERR,
    //DAP_CHAIN_NODE_CLI_COM_LEDGER_DAP_DB_HISTORY_ADDR_ERR,
    //DAP_CHAIN_NODE_CLI_COM_LEDGER_DAP_DB_HISTORY_ALL_ERR,
