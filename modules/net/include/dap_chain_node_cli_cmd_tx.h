...
typedef enum s_com_ledger_err{
    ...
    DAP_CHAIN_NODE_CLI_COM_LEDGER_EVENT_PARAM_ERR,
    DAP_CHAIN_NODE_CLI_COM_LEDGER_EVENT_HASH_ERR,
    DAP_CHAIN_NODE_CLI_COM_LEDGER_EVENT_NOT_FOUND_ERR,
    DAP_CHAIN_NODE_CLI_COM_LEDGER_CHAIN_TYPE_ERR,
