...
#define DAP_CHAIN_NODE_CLI_COM_TOKEN_EMIT_REQUIRES_PARAMETER_CHAIN_EMISSION dap_cli_error_code_get("TOKEN_EMIT_REQUIRES_PARAMETER_CHAIN_EMISSION")
#define DAP_CHAIN_NODE_CLI_COM_TOKEN_EMIT_REQUIRES_PARAMETER_EMISSION    dap_cli_error_code_get("TOKEN_EMIT_REQUIRES_PARAMETER_EMISSION")
...
#define DAP_CHAIN_NODE_CLI_COM_CHAIN_CA_PUB_CANT_FIND_CERT_ERR              dap_cli_error_code_get("CHAIN_CA_PUB_CANT_FIND_CERT_ERR")
#define DAP_CHAIN_NODE_CLI_COM_CHAIN_CA_PUB_CORRUPTED_CERT_ERR              dap_cli_error_code_get("CHAIN_CA_PUB_CORRUPTED_CERT_ERR")
