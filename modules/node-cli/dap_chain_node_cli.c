...
//                    "global_db wallet_info set -addr <wallet address> -cell <cell id> \n\n"
    ...
    dap_cli_server_cmd_add("mempool", com_mempool, "Command for working with mempool", DAP_CHAIN_NODE_CLI_CMD_ID_MEMPOOL,
    ...
    dap_cli_server_cmd_add ("tx_create", com_tx_create, "Make transaction", DAP_CHAIN_NODE_CLI_CMD_ID_TX_CREATE,
                ...
                "\texample coins amount syntax (only natural) 1.0 123.4567\n"
                "\texample datoshi amount syntax (only integer) 1 20 0.4321e+4\n\n");
    dap_cli_server_cmd_add ("tx_create_json", com_tx_create_json, "Make transaction", DAP_CHAIN_NODE_CLI_CMD_ID_TX_CREATE,
    ...
    dap_cli_server_cmd_add ("file", com_file, "Work with logs and files", DAP_CHAIN_NODE_CLI_CMD_ID_FILE,
