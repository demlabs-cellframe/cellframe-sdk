...
/**
 * @brief callback to collect info about cmd calls
 * REMOVED: moved to cmd module where cmd IDs are known
...
#ifdef DAP_OS_LINUX
/**
 * @brief update about current node RPC states
...
void dap_chain_node_rpc_init(dap_config_t *a_cfg)
{
    ...
    switch (s_current_role) {
        ...
        case RPC_ROLE_SERVER:
            ...
            // REMOVED: cmd statistics initialization - moved to cmd module
