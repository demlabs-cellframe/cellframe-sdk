 ...
 */
void dap_chain_srv_stake_ext_test_run(void)
{
    dap_print_module_name("DAP_CHAIN_NET_SRV_STAKE_EXT_TESTS");
    ...
    dap_chain_srv_stake_ext_test_cache_init();
    dap_chain_srv_stake_ext_test_cache_stake_ext_management();
    dap_chain_srv_stake_ext_test_cache_lock_management();
    dap_chain_srv_stake_ext_test_cache_statistics();
    
    dap_test_msg("=== 2. STAKE_EXT STATE TESTS ===");
    dap_chain_srv_stake_ext_test_status_transitions();
    dap_chain_srv_stake_ext_test_status_validation();
    
    dap_test_msg("=== 3. TRANSACTION TESTS ===");
    dap_chain_srv_stake_ext_test_event_processing();
    dap_chain_srv_stake_ext_test_lock_transactions();
    dap_chain_srv_stake_ext_test_unlock_transactions();
    
    dap_test_msg("=== 4. LEDGER INTEGRATION TESTS ===");
    dap_chain_srv_stake_ext_test_event_callbacks();
    dap_chain_srv_stake_ext_test_ledger_sync();
    dap_chain_srv_stake_ext_test_verificators();
    
    dap_test_msg("=== 5. DATA PROCESSING TESTS ===");
    dap_chain_srv_stake_ext_test_data_parsing();
    dap_chain_srv_stake_ext_test_boundary_conditions();
    
    dap_test_msg("=== 6. SECURITY AND ERROR TESTS ===");
    dap_chain_srv_stake_ext_test_error_handling();
    dap_chain_srv_stake_ext_test_thread_safety();
 ...
 */
void  dap_chain_srv_stake_ext_test_cache_init(void)
{
    dap_test_msg("Testing stake_ext cache initialization...");
    
    // Test 1: Basic cache creation
    dap_test_msg("Test 1: Basic cache creation");
    dap_chain_srv_stake_ext_cache_t *l_cache = dap_chain_srv_stake_ext_cache_create();
    ...
    dap_chain_srv_stake_ext_cache_delete(l_cache);
    ...
    dap_chain_srv_stake_ext_cache_delete(NULL); // Should not crash
    ...
    dap_chain_srv_stake_ext_cache_t *l_cache1 = dap_chain_srv_stake_ext_cache_create();
    dap_chain_srv_stake_ext_cache_t *l_cache2 = dap_chain_srv_stake_ext_cache_create();
    ...
    dap_chain_srv_stake_ext_cache_delete(l_cache1);
    dap_chain_srv_stake_ext_cache_delete(l_cache2);
    ...
    l_cache = dap_chain_srv_stake_ext_cache_create();
 ...
 */
void dap_chain_srv_stake_ext_test_cache_stake_ext_management(void)
{
    ...
    dap_chain_srv_stake_ext_cache_item_t *l_found_stake_ext = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_stake_ext_hash);
    ...
    dap_chain_srv_stake_ext_cache_item_t *l_found_by_name = dap_chain_srv_stake_ext_cache_find_stake_ext_by_name(l_cache, l_group_name);
    ...
    l_result = dap_chain_srv_stake_ext_cache_update_stake_ext_status(l_cache, &l_stake_ext_hash, DAP_STAKE_EXT_STATUS_ENDED);
    ...
    l_result = dap_chain_srv_stake_ext_cache_add_stake_ext(l_cache, &l_stake_ext_hash2, l_net_id, 
    ...
    l_result = dap_chain_srv_stake_ext_cache_add_stake_ext(l_cache, &l_stake_ext_hash, l_net_id, 
                                            l_group_name, l_started_data, l_timestamp);
    ...
    dap_chain_srv_stake_ext_cache_item_t *l_not_found_by_name = dap_chain_srv_stake_ext_cache_find_stake_ext_by_name(l_cache, "nonexistent");
    ...
    l_result = dap_chain_srv_stake_ext_cache_update_stake_ext_status(l_cache, &l_nonexistent_hash, DAP_STAKE_EXT_STATUS_CANCELLED);
 ...
 */
void dap_chain_srv_stake_ext_test_cache_lock_management(void)
{
    ...
    l_result = dap_chain_srv_stake_ext_cache_add_lock(l_cache, &l_stake_ext_hash, &l_lock_hash, 
    ...
    dap_chain_srv_stake_ext_cache_item_t *l_stake_ext = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_stake_ext_hash);
    ...
    dap_chain_srv_stake_ext_lock_cache_item_t *l_found_lock = dap_chain_srv_stake_ext_cache_find_lock(l_stake_ext, &l_lock_hash);
    ...
    l_result = dap_chain_srv_stake_ext_cache_add_lock(l_cache, &l_stake_ext_hash, &l_lock_hash2, 
    ...
    dap_chain_srv_stake_ext_position_cache_item_t *l_position = dap_chain_srv_stake_ext_cache_find_position(l_stake_ext, l_position_id);
    l_result = dap_chain_srv_stake_ext_cache_unlock_lock(l_position, &l_lock_hash);
    dap_assert_PIF(l_result == 0, "Lock unlocking should succeed");
    dap_assert_PIF(l_found_lock->is_unlocked == true, "Lock should be marked as unlocked");
    dap_pass_msg("Test 5: Testing lock unlocking: passed");
    ...
    dap_chain_srv_stake_ext_position_cache_item_t *l_position2 = dap_chain_srv_stake_ext_cache_find_position(l_stake_ext, l_position_id);
    l_result = dap_chain_srv_stake_ext_cache_unlock_lock(l_position2, &l_nonexistent_lock);
    dap_assert_PIF(l_result != 0, "Unlock non-existent lock should fail");
    dap_pass_msg("Test 9: Testing non-existent lock unlocking rejection: passed");
 ...
 */
void dap_chain_srv_stake_ext_test_cache_statistics(void)
{
    ...
    int l_result = dap_chain_srv_stake_ext_cache_add_stake_ext(l_cache, &l_stake_ext_hash1, l_net_id, 
    ...
    // End first stake_ext
    l_result = dap_chain_srv_stake_ext_cache_update_stake_ext_status(l_cache, &l_stake_ext_hash1, DAP_STAKE_EXT_STATUS_ENDED);
    dap_assert_PIF(l_result == 0, "Status update should succeed");
    dap_assert_PIF(l_cache->total_stake_ext == 2, "Total stake_ext should remain 2");
    dap_assert_PIF(l_cache->active_stake_ext == 1, "Active stake_ext should be 1");
    
    // Cancel second stake_ext
    l_result = dap_chain_srv_stake_ext_cache_update_stake_ext_status(l_cache, &l_stake_ext_hash2, DAP_STAKE_EXT_STATUS_CANCELLED);
    dap_assert_PIF(l_result == 0, "Status update should succeed");
    dap_assert_PIF(l_cache->total_stake_ext == 2, "Total stake_ext should remain 2");
    ...
    l_result = dap_chain_srv_stake_ext_cache_update_stake_ext_status(l_cache, &l_stake_ext_hash1, DAP_STAKE_EXT_STATUS_ACTIVE);
    dap_assert_PIF(l_result == 0, "Reactivation should succeed");
    dap_assert_PIF(l_cache->active_stake_ext == 1, "Active stake_ext should be 1");
    
    // Get stake_ext and verify initial lock count
    dap_chain_srv_stake_ext_cache_item_t *l_stake_ext = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_stake_ext_hash1);
    dap_assert_PIF(l_stake_ext != NULL, "Stake_ext should be found");
    ...
    l_result = dap_chain_srv_stake_ext_cache_add_lock(l_cache, &l_stake_ext_hash1, &l_lock_hash1, 
    ...
    l_result = dap_chain_srv_stake_ext_cache_add_lock(l_cache, &l_stake_ext_hash1, &l_lock_hash2, 
                                        l_lock_amount, dap_time_now() + 7776000, dap_time_now(),
                                        l_position_id);
    dap_assert_PIF(l_result == 0, "Second lock should be added");
    ...
    // Unlock one lock
    dap_chain_srv_stake_ext_position_cache_item_t *l_position = dap_chain_srv_stake_ext_cache_find_position(l_stake_ext, l_position_id);
    l_result = dap_chain_srv_stake_ext_cache_unlock_lock(l_position, &l_lock_hash1);
    dap_assert_PIF(l_result == 0, "Lock unlocking should succeed");
    ...
    l_result = dap_chain_srv_stake_ext_cache_update_stake_ext_status(l_cache, &l_stake_ext_hash2, DAP_STAKE_EXT_STATUS_ENDED);
    dap_assert_PIF(l_result == 0, "Status update should succeed");
    ...
    dap_chain_srv_stake_ext_cache_item_t *l_stake_ext2 = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_stake_ext_hash2);
 ...
 */
void dap_chain_srv_stake_ext_test_status_transitions(void)
{
    ...
    int l_result = dap_chain_srv_stake_ext_cache_add_stake_ext(l_cache, &l_stake_ext_hash, l_net_id, l_group_name, l_started_data, l_timestamp);
    dap_assert_PIF(l_result == 0, "Stake_ext should be added successfully");
    ...
    l_result = dap_chain_srv_stake_ext_cache_add_stake_ext(l_cache, &l_stake_ext_hash2, l_net_id, l_group_name2, l_started_data2, l_timestamp);
    dap_assert_PIF(l_result == 0, "Second stake_ext should be added");
    dap_assert_PIF(l_cache->active_stake_ext == 1, "Active stake_ext should be 1");
    ...
    l_result = dap_chain_srv_stake_ext_cache_update_stake_ext_status(l_cache, &l_stake_ext_hash, DAP_STAKE_EXT_STATUS_ACTIVE);
    ...
    l_result = dap_chain_srv_stake_ext_cache_update_stake_ext_status(l_cache, &l_stake_ext_hash2, DAP_STAKE_EXT_STATUS_ACTIVE);
    ...
    l_result = dap_chain_srv_stake_ext_cache_update_stake_ext_status(l_cache, &l_stake_ext_hash, DAP_STAKE_EXT_STATUS_CANCELLED);
    ...
    l_result = dap_chain_srv_stake_ext_cache_update_stake_ext_status(l_cache, &l_stake_ext_hash, DAP_STAKE_EXT_STATUS_UNKNOWN);
 ...
 */
void dap_chain_srv_stake_ext_test_status_validation(void)
{
    dap_test_msg("Testing stake_ext status validation...");

    // Test 1: dap_chain_srv_stake_ext_status_to_str() for all valid statuses
    dap_test_msg("Test 1: Testing dap_chain_srv_stake_ext_status_to_str()");
    
    const char *l_unknown_str = dap_chain_srv_stake_ext_status_to_str(DAP_STAKE_EXT_STATUS_UNKNOWN);
    dap_assert_PIF(strcmp(l_unknown_str, "unknown") == 0, "UNKNOWN status should return 'unknown'");
    
    const char *l_expired_str = dap_chain_srv_stake_ext_status_to_str(DAP_STAKE_EXT_STATUS_EXPIRED);
    dap_assert_PIF(strcmp(l_expired_str, "expired") == 0, "EXPIRED status should return 'expired'");
    
    const char *l_active_str = dap_chain_srv_stake_ext_status_to_str(DAP_STAKE_EXT_STATUS_ACTIVE);
    dap_assert_PIF(strcmp(l_active_str, "active") == 0, "ACTIVE status should return 'active'");
    
    const char *l_ended_str = dap_chain_srv_stake_ext_status_to_str(DAP_STAKE_EXT_STATUS_ENDED);
    dap_assert_PIF(strcmp(l_ended_str, "ended") == 0, "ENDED status should return 'ended'");
    
    const char *l_cancelled_str = dap_chain_srv_stake_ext_status_to_str(DAP_STAKE_EXT_STATUS_CANCELLED);
    ...
    // Test 2: Invalid status handling in dap_chain_srv_stake_ext_status_to_str()
    dap_test_msg("Test 2: Testing invalid status handling");
    
    const char *l_invalid_str1 = dap_chain_srv_stake_ext_status_to_str((dap_chain_srv_stake_ext_status_t)999);
    dap_assert_PIF(strcmp(l_invalid_str1, "invalid") == 0, "Invalid status should return 'invalid'");
    
    const char *l_invalid_str2 = dap_chain_srv_stake_ext_status_to_str((dap_chain_srv_stake_ext_status_t)-1);
    dap_assert_PIF(strcmp(l_invalid_str2, "invalid") == 0, "Negative status should return 'invalid'");
    
    dap_pass_msg("Invalid status handling - ");

    // Test 3: dap_chain_srv_stake_ext_status_from_event_type() for all event types
    dap_test_msg("Test 3: Testing dap_chain_srv_stake_ext_status_from_event_type()");
    
    dap_chain_srv_stake_ext_status_t l_status_started = dap_chain_srv_stake_ext_status_from_event_type(DAP_CHAIN_TX_EVENT_TYPE_STAKE_EXT_STARTED);
    dap_assert_PIF(l_status_started == DAP_STAKE_EXT_STATUS_ACTIVE, "STAKE_EXT_STARTED event should return ACTIVE status");
    
    dap_chain_srv_stake_ext_status_t l_status_cancelled = dap_chain_srv_stake_ext_status_from_event_type(DAP_CHAIN_TX_EVENT_TYPE_STAKE_EXT_CANCELLED);
    ...
    // Test 4: Invalid event types in dap_chain_srv_stake_ext_status_from_event_type()
    dap_test_msg("Test 4: Testing invalid event type handling");
    
    dap_chain_srv_stake_ext_status_t l_status_invalid1 = dap_chain_srv_stake_ext_status_from_event_type(DAP_CHAIN_TX_EVENT_TYPE_STAKE_EXT_LOCK_PLACED);
    dap_assert_PIF(l_status_invalid1 == DAP_STAKE_EXT_STATUS_UNKNOWN, "LOCK_PLACED event should return UNKNOWN status");
    
    dap_chain_srv_stake_ext_status_t l_status_invalid2 = dap_chain_srv_stake_ext_status_from_event_type(DAP_CHAIN_TX_EVENT_TYPE_STAKE_EXT_ENDED);
    ...
    dap_chain_srv_stake_ext_status_t l_status_invalid3 = dap_chain_srv_stake_ext_status_from_event_type(9999);
    dap_assert_PIF(l_status_invalid3 == DAP_STAKE_EXT_STATUS_UNKNOWN, "Invalid event type should return UNKNOWN status");
    
    dap_chain_srv_stake_ext_status_t l_status_invalid4 = dap_chain_srv_stake_ext_status_from_event_type(0);
    ...
    const char *l_active_string = dap_chain_srv_stake_ext_status_to_str(DAP_STAKE_EXT_STATUS_ACTIVE);
    ...
    const char *l_ended_string = dap_chain_srv_stake_ext_status_to_str(DAP_STAKE_EXT_STATUS_ENDED);
    ...
    dap_chain_srv_stake_ext_status_t l_status_max = dap_chain_srv_stake_ext_status_from_event_type(0xFFFF);
    ...
    for (int i = DAP_STAKE_EXT_STATUS_UNKNOWN; i <= DAP_STAKE_EXT_STATUS_CANCELLED; i++) {
        const char *l_str = dap_chain_srv_stake_ext_status_to_str((dap_chain_srv_stake_ext_status_t)i);
 ...
 */
void dap_chain_srv_stake_ext_test_event_processing(void)
{
    ...
    l_found_stake_ext = dap_chain_srv_stake_ext_cache_find_stake_ext_by_name(l_cache, l_group_name);
    ...
    l_result = dap_chain_srv_stake_ext_cache_update_stake_ext_status(l_cache, &l_stake_ext_hash_cancel, DAP_STAKE_EXT_STATUS_CANCELLED);
    dap_assert_PIF(l_result == 0, "Failed to update stake_ext status to CANCELLED");
    
    // Verify stake_ext status updated to CANCELLED
    dap_chain_srv_stake_ext_cache_item_t *l_cancelled_stake_ext = dap_chain_srv_stake_ext_cache_find_stake_ext_by_name(l_cache, l_group_name_cancel);
 ...
 */
void dap_chain_srv_stake_ext_test_lock_transactions(void)
{
    ...
    l_found_stake_ext = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_stake_ext_hash);
...
/**
 * @brief Test lock unlocking transactions
 */
void dap_chain_srv_stake_ext_test_unlock_transactions(void)
{
    dap_test_msg("Testing lock unlocking transactions...");
    
    // ===== Test Setup =====
    
    // Create test keys for lockder and other users
    char *l_lockder_seed = "unlocking_lockder_key_test_12345";
    char *l_other_seed = "unlocking_other_key_test_67890";
    ...
    l_result = dap_chain_srv_stake_ext_cache_add_lock(l_cache, &l_stake_ext_hash, &l_lock_tx_hash, 
                                        l_lock_amount, l_lock_time, dap_time_now(),
                                        l_position_id);
    ...
    // ===== Test 1: Valid Unlocking Parameters =====
    dap_test_msg("Test 1: Testing valid unlocking parameters");
    
    dap_assert_PIF(l_key_lockder, "Lockder key should be valid for unlocking");
    dap_assert_PIF(!IS_ZERO_256(l_unlocking_fee), "Unlocking fee should not be zero");
    
    dap_chain_srv_stake_ext_cache_item_t *l_stake_ext = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_stake_ext_hash);
    dap_assert_PIF(l_stake_ext, "Stake_ext should exist for unlocking");
    dap_assert_PIF(l_stake_ext->locks_count > 0, "Lock should exist for unlocking");
    
    // ===== Test 2: Lock Existence Verification =====
    dap_test_msg("Test 2: Testing lock existence verification");
    
    dap_chain_srv_stake_ext_cache_item_t *l_stake_ext_for_lock = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_stake_ext_hash);
    dap_chain_srv_stake_ext_lock_cache_item_t *l_found_lock = dap_chain_srv_stake_ext_cache_find_lock(l_stake_ext_for_lock, &l_lock_tx_hash);
    ...
    dap_test_msg("Test 4: Testing invalid unlocking scenarios");
    
    uint256_t l_zero_fee = uint256_0;
    dap_assert_PIF(IS_ZERO_256(l_zero_fee), "Zero fee should be detected as invalid");
    
    // Test unlocking of lock
    dap_chain_srv_stake_ext_position_cache_item_t *l_position = dap_chain_srv_stake_ext_cache_find_position(l_stake_ext, l_position_id);
    l_result = dap_chain_srv_stake_ext_cache_unlock_lock(l_position, &l_lock_tx_hash);
    dap_assert_PIF(l_result == 0, "Should be able to mark lock as unlocked");
    
    l_found_lock = dap_chain_srv_stake_ext_cache_find_lock(l_stake_ext_for_lock, &l_lock_tx_hash);
    ...
    uint256_t l_min_fee = dap_chain_uint256_from(1);
    dap_assert_PIF(compare256(l_unlocking_fee, l_min_fee) >= 0, "Fee should meet minimum");
    
    bool l_fee_reasonable = (compare256(l_unlocking_fee, l_lock_amount) < 0);
    ...
    dap_assert_PIF(!compare256(l_unlocking.fee, l_unlocking_fee), "Fee should be preserved");
    dap_assert_PIF(!compare256(l_unlocking.return_amount, l_lock_amount), "Amount should match");
    ...
    dap_pass_msg("Unlocking transaction tests: ");
}
 ...
 */
void dap_chain_srv_stake_ext_test_event_callbacks(void)
{
    ...
    dap_chain_srv_stake_ext_cache_item_t *l_found = dap_chain_srv_stake_ext_cache_find_stake_ext_by_name(l_cache, l_group_name);
    ...
    dap_chain_srv_stake_ext_cache_event_callback(NULL, l_ledger, &l_event_added, &l_tx_hash, 
                                    DAP_LEDGER_NOTIFY_OPCODE_ADDED);
    dap_test_msg("NULL cache parameter handled gracefully");
    
    // Test NULL ledger parameter  
    dap_chain_srv_stake_ext_cache_event_callback((void*)l_cache, NULL, &l_event_added, &l_tx_hash, 
                                    DAP_LEDGER_NOTIFY_OPCODE_ADDED);
    dap_test_msg("NULL ledger parameter handled gracefully");
    
    // Test NULL event parameter
    dap_chain_srv_stake_ext_cache_event_callback((void*)l_cache, l_ledger, NULL, &l_tx_hash, 
                                    DAP_LEDGER_NOTIFY_OPCODE_ADDED);
    dap_test_msg("NULL event parameter handled gracefully");
    
    // Test NULL transaction hash parameter
    dap_chain_srv_stake_ext_cache_event_callback((void*)l_cache, l_ledger, &l_event_added, NULL, 
                                    DAP_LEDGER_NOTIFY_OPCODE_ADDED);
    ...
    dap_chain_srv_stake_ext_cache_event_callback((void*)l_cache, l_ledger, &l_event_invalid, &l_tx_hash, 
                                    DAP_LEDGER_NOTIFY_OPCODE_ADDED);
    ...
    dap_chain_srv_stake_ext_cache_event_callback((void*)l_cache, l_ledger, &l_event_bad_size, &l_tx_hash, 
                                    DAP_LEDGER_NOTIFY_OPCODE_ADDED);
    ...
    l_found = dap_chain_srv_stake_ext_cache_find_stake_ext_by_name(l_cache, l_group_name);
 ...
 */
void dap_chain_srv_stake_ext_test_ledger_sync(void)
{
    ...
    for(int i = 0; i < 3; i++) {
        int l_result = dap_chain_srv_stake_ext_cache_add_stake_ext(l_cache, &l_stake_ext_hashes[i], l_net_id, 
    ...
    for(int i = 0; i < 3; i++) {
        dap_chain_srv_stake_ext_cache_item_t *l_found = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_stake_ext_hashes[i]);
        ...
        dap_chain_srv_stake_ext_cache_item_t *l_found_by_name = dap_chain_srv_stake_ext_cache_find_stake_ext_by_name(l_cache, l_group_names[i]);
    ...
    dap_chain_srv_stake_ext_cache_item_t *l_rollback_stake_ext = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_stake_ext_hashes[2]);
    ...
    int l_result = dap_chain_srv_stake_ext_cache_add_stake_ext(l_cache, &l_stake_ext_hashes[3], l_net_id, 
    ...
    dap_chain_srv_stake_ext_cache_item_t *l_new_stake_ext = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_stake_ext_hashes[3]);
    ...
    for(int i = 0; i < 3; i++) {
        dap_chain_srv_stake_ext_cache_item_t *l_existing = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_stake_ext_hashes[i]);
    ...
    for(int i = 0; i < 4; i++) {
        ...
        l_result = dap_chain_srv_stake_ext_cache_update_stake_ext_status(l_cache, &l_stake_ext_hashes[i], DAP_STAKE_EXT_STATUS_ENDED);
        ...
        l_result = dap_chain_srv_stake_ext_cache_update_stake_ext_status(l_cache, &l_stake_ext_hashes[i], DAP_STAKE_EXT_STATUS_ACTIVE);
    ...
    dap_chain_srv_stake_ext_cache_item_t *l_test_stake_ext = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_stake_ext_hashes[0]);
    ...
    for(int i = 0; i < 10; i++) {
        dap_chain_srv_stake_ext_cache_item_t *l_concurrent_find = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_stake_ext_hashes[i % 4]);
    ...
    for(int i = 0; i < 100; i++) {
        dap_chain_srv_stake_ext_cache_item_t *l_perf_find = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_stake_ext_hashes[i % 4]);
        if(l_perf_find) {
            // Access stake_ext properties (simulating ledger sync read operations)
            volatile dap_chain_srv_stake_ext_status_t l_status = l_perf_find->status;
 ...
 */
void dap_chain_srv_stake_ext_test_verificators(void)
{
    ...
    *((uint32_t*)(l_stake_ext_data + 1)) = 3001; // Position ID
    ...
    for(int i = 0; i < 5; i++) {
        dap_chain_srv_stake_ext_cache_item_t *l_verify_stake_ext = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_stake_ext_hash);
    ...
    uint256_t l_lock_amount_256 = GET_256_FROM_64(l_lock_cond->lock_amount);
    l_result = dap_chain_srv_stake_ext_cache_add_lock(l_cache, &l_stake_ext_hash, &l_lock_tx_hash, 
    ...
    dap_chain_srv_stake_ext_cache_item_t *l_updated_stake_ext = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_stake_ext_hash);
    ...
    // Find the added lock
    dap_chain_srv_stake_ext_lock_cache_item_t *l_added_lock = dap_chain_srv_stake_ext_cache_find_lock(l_updated_stake_ext, &l_lock_tx_hash);
    ...
    for(int i = 0; i < 50; i++) {
        ...
        dap_chain_srv_stake_ext_cache_item_t *l_perf_stake_ext = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_stake_ext_hash);
        if(l_perf_stake_ext) {
 ...
 */
void dap_chain_srv_stake_ext_test_data_parsing(void)
{
 ...
 */
void dap_chain_srv_stake_ext_test_boundary_conditions(void)
{
 ...
 */
void dap_chain_srv_stake_ext_test_error_handling(void)
{
    ...
    dap_chain_srv_stake_ext_cache_item_t *l_result = dap_chain_srv_stake_ext_cache_find_stake_ext(NULL, &l_test_hash);
    dap_assert_PIF(l_result == NULL, "NULL cache should return NULL result");
    
    // Test NULL hash parameter
    l_result = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, NULL);
    ...
    int l_update_result = dap_chain_srv_stake_ext_cache_update_stake_ext_status(l_cache, &l_test_hash, 
                                                                 (dap_chain_srv_stake_ext_status_t)0xFF);
    ...
    l_add_result = dap_chain_srv_stake_ext_cache_add_stake_ext(l_cache, &l_large_hash, l_net_id, 
    ...
    l_add_result = dap_chain_srv_stake_ext_cache_add_stake_ext(l_cache, &l_test_hash, l_net_id, 
                                               l_group_name, &l_started_data, dap_time_now());
    ...
    l_result = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_test_hash);
    ...
    dap_chain_srv_stake_ext_cache_t *l_test_cache = dap_chain_srv_stake_ext_cache_create();
    dap_assert_PIF(l_test_cache, "Failed to create consistency test cache");
    
    // Test consistent error behavior
    for(int i = 0; i < 3; i++) {
        l_result = dap_chain_srv_stake_ext_cache_find_stake_ext(l_test_cache, NULL);
        dap_assert_PIF(l_result == NULL, "Error behavior should be consistent across calls");
    }
    
    // Final cleanup
    dap_chain_srv_stake_ext_cache_delete(l_test_cache);
 ...
 */
void dap_chain_srv_stake_ext_test_thread_safety(void)
{
    ...
    for(int i = 0; i < 10; i++) {
        ...
        int l_add_result = dap_chain_srv_stake_ext_cache_add_stake_ext(l_cache, &l_stake_ext_hash, l_net_id, 
                                                       l_group_name, &l_started_data, dap_time_now());
        ...
        if(l_add_result == 0) {
            dap_chain_srv_stake_ext_cache_item_t *l_found = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_stake_ext_hash);
        ...
        if(l_add_result == 0) {
            int l_update_result = dap_chain_srv_stake_ext_cache_update_stake_ext_status(l_cache, &l_stake_ext_hash, 
    ...
    int l_add_result = dap_chain_srv_stake_ext_cache_add_stake_ext(l_cache, &l_shared_hash, l_net_id, 
                                                   l_group_name, &l_started_data, dap_time_now());
    ...
    for(int i = 0; i < 5; i++) {
        dap_chain_srv_stake_ext_status_t l_test_status = (i % 2 == 0) ? DAP_STAKE_EXT_STATUS_ENDED : DAP_STAKE_EXT_STATUS_ACTIVE;
        int l_update_result = dap_chain_srv_stake_ext_cache_update_stake_ext_status(l_cache, &l_shared_hash, l_test_status);
        // Log only failures
        ...
        if(l_add_result == 0) {
            dap_chain_srv_stake_ext_cache_item_t *l_found = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_shared_hash);
    ...
    for(int i = 0; i < l_stake_ext_count; i++) {
        ...
        l_add_result = dap_chain_srv_stake_ext_cache_add_stake_ext(l_cache, &l_stake_ext_hashes[i], l_net_id, 
                                                   l_group_name, &l_started_data, dap_time_now());
    ...
    for(int round = 0; round < 3; round++) {
        for(int i = 0; i < l_stake_ext_count; i++) {
            ...
            if(l_found) {
                dap_chain_srv_stake_ext_status_t l_new_status = (round % 2 == 0) ? DAP_STAKE_EXT_STATUS_ENDED : DAP_STAKE_EXT_STATUS_ACTIVE;
                int l_update_result = dap_chain_srv_stake_ext_cache_update_stake_ext_status(l_cache, &l_stake_ext_hashes[i], l_new_status);
                // Log only failures (and only first few to avoid spam)
                if (l_update_result != 0 && i < 3) {
    ...
    l_add_result = dap_chain_srv_stake_ext_cache_add_stake_ext(l_cache, &l_race_hash, l_net_id, 
                                               l_group_name, &l_started_data, dap_time_now());
    // Log only if creation failed
    if (l_add_result != 0) {
    ...
    for(int i = 0; i < 10; i++) {
        dap_chain_srv_stake_ext_cache_item_t *l_found = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_race_hash);
        if(l_found) {
            // If found, try to update (simulating thread 1)
            int l_update_result = dap_chain_srv_stake_ext_cache_update_stake_ext_status(l_cache, &l_race_hash, 
                                                                         DAP_STAKE_EXT_STATUS_ENDED);
            // Log only update failures
        ...
        dap_chain_srv_stake_ext_cache_item_t *l_found2 = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_race_hash);
        // Log only find failures
        if (!l_found2) {
    ...
    l_add_result = dap_chain_srv_stake_ext_cache_add_stake_ext(l_cache, &l_lock_stake_ext_hash, l_net_id, 
                                               l_group_name, &l_started_data, dap_time_now());
    // Log only if creation failed
    if (l_add_result != 0) {
    ...
    for(int i = 0; i < 5; i++) {
        ...
        l_lock_amount = GET_256_FROM_64(1000000 + i * 100000);
        
        // Simulate thread adding lock
        int l_lock_result = dap_chain_srv_stake_ext_cache_add_lock(l_cache, &l_lock_stake_ext_hash, &l_lock_hash, 
        ...
        dap_chain_srv_stake_ext_cache_item_t *l_stake_ext = dap_chain_srv_stake_ext_cache_find_stake_ext(l_cache, &l_lock_stake_ext_hash);
        if(l_stake_ext) {
    ...
    if(l_test_cache) {
        ...
        l_add_result = dap_chain_srv_stake_ext_cache_add_stake_ext(l_test_cache, &l_isolation_hash, l_net_id, 
                                                   l_group_name, &l_started_data, dap_time_now());
        dap_test_msg("Isolated operation add: %s", (l_add_result == 0) ? "succeeded" : "failed");
        
        dap_chain_srv_stake_ext_cache_item_t *l_isolated_stake_ext = dap_chain_srv_stake_ext_cache_find_stake_ext(l_test_cache, &l_isolation_hash);
