...
static int s_cli_srv_stake(int a_argc, char **a_argv, void **a_str_reply)
{
    ...
    switch (l_cmd_num) {
        ...
        case CMD_CHECK:
        {
            ...
            json_object_object_add(json_obj_order, "VERSION", json_object_new_string(*(int*)l_out.header.version));
        ...
        case CMD_LIST: {
            ...
            if (dap_cli_server_cmd_find_option_val(a_argv, l_arg_index, a_argc, "keys", NULL)) {
                ...
                if (!HASH_CNT(hh, l_srv_stake->itemlist)) {
                    ...
                    json_object_object_add(l_json_obj_keys_count, "total_effective_weight", json_object_new_string(l_total_weight_coins));
                }
