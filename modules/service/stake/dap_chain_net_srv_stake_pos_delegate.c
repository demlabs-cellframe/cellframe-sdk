...
int dap_chain_net_srv_stake_pos_delegate_init()
{
    ...
    "srv_stake order list [fee | validator | staker] -net <net_name> [-limit] [-offset] [-head] [-full] [-h]\n"
    ...
    "srv_stake list keys -net <net_name> [-cert <delegated_cert> | -pkey <pkey_hash_str>] [-limit] [-offset] [-head] [-full] [-h]\n"
