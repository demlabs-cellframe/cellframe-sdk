...
static int s_cli_voting(int a_argc, char **a_argv, void **a_str_reply)
{
    ...
    case CMD_LIST:{
        ...
        json_object_object_add(json_vote_out, "list_of_votings_in_net", json_object_new_string(l_net->pub.name));
    ...
    case CMD_DUMP:{
        ...
        json_object* json_vote_out = json_object_new_object();
        json_object_object_add(json_vote_out, "voting_tx", json_object_new_string(l_hash_str));
        ...
        for (dap_list_t *l_option = l_voting->voting_params.option_offsets_list; l_option; l_option = l_option->next, ++i) {
            ...
            json_object_object_add( json_vote_obj, "vote_tx", 
