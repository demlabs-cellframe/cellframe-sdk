...
{
    if (!dap_strcmp("0xF934920010A901571B44FBFBC8FE91386D2513892A977249BF9AA1F279FDCF01", dap_hash_fast_to_str_static(a_tx_hash)))
        log_it(L_ATT, "Bingo!");
    ...
    if (!a_apply) {
        ...
        dap_list_t *it, *tmp;
        DL_FOREACH_SAFE(l_voting->votes, it, tmp) {
