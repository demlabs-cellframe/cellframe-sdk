        ...
        dap_chain_wallet_t *a_wallet, const char *a_token_ticker, uint64_t a_value_datoshi)
{
    ...
    if(!l_tx_cond_hash) {
        ...
        uint256_t l_zero = {};
        char *l_tx_cond_hash_str = NULL; //dap_chain_mempool_tx_create_cond(a_net, l_enc_key, l_client_key, a_token_ticker,
...
int dap_chain_net_vpn_client_init(dap_config_t * g_config)
{
    ...
    // vpn client command
    dap_cli_server_cmd_add ("vpn_client", com_vpn_client, NULL, "VPN client control",
