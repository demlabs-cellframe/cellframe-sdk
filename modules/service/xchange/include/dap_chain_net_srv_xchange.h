...
typedef enum dap_chain_net_srv_xchange_remove_error_list{
    ...
    XCHANGE_REMOVE_ERROR_CAN_NOT_PUT_TRANSACTION_TO_MEMPOOL
...
typedef enum dap_chain_net_srv_xchange_purchase_error_list{
    ...
    XCHANGE_PURCHASE_ERROR_CAN_NOT_PUT_TRANSACTION_TO_MEMPOOL
...
typedef enum dap_chain_net_srv_xchange_order_status {
    XCHANGE_ORDER_STATUS_UNKNOWN = -1, XCHANGE_ORDER_STATUS_CLOSED, XCHANGE_ORDER_STATUS_OPENED
