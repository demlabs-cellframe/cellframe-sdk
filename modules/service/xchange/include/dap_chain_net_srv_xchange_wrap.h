/**
 * @file dap_chain_net_srv_xchange_wrap.h
 * @brief Wrapper functions for xchange service operations
 * 
 * This file declares wrapper functions for xchange operations that can be
 * mocked during unit testing. The wrappers provide an indirection layer
 * between CLI commands and actual xchange logic.
 * 
