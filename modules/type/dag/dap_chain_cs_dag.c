...
int dap_chain_cs_dag_update(dap_chain_cs_dag_t * l_dag_updated)
{
    dap_chain_global_db_add_sync_group("round-gdb", s_history_callback_round_notify, l_dag_updated);
    return 0;
}
