...
/**
 * @file dap_chain_type_dag_wrap.c
 * @brief Wrapper functions for DAG event operations
 * 
 ...
 * 
 * Similar to dap_chain_block_cache_wrap.c for blocks module.
 */
...
{
    return dap_chain_type_dag_find_event_by_hash(a_dag, a_hash);
}
...
{
    return dap_chain_type_dag_get_events_count(a_dag);
}
...
{
    return dap_chain_type_dag_get_threshold_count(a_dag);
}
...
{
    return dap_chain_type_dag_get_last_event(a_dag, a_event_number, a_event_hash, a_ts_created);
}
