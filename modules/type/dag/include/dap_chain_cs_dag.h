...
typedef enum s_com_dag_err{
    ...
    DAP_CHAIN_NODE_CLI_COM_DAG_MEMORY_ERR,
    DAP_CHAIN_NODE_CLI_COM_DAG_VERIF_ERR,
    DAP_CHAIN_NODE_CLI_COM_DAG_HASH_ERR,
    DAP_CHAIN_NODE_CLI_COM_DAG_FIND_ERR,
    DAP_CHAIN_NODE_CLI_COM_DAG_DATUM_SIZE_ERR,
    DAP_CHAIN_NODE_CLI_COM_DAG_CERT_ERR,
    DAP_CHAIN_NODE_CLI_COM_DAG_PUB_KEY_ERR,
    DAP_CHAIN_NODE_CLI_COM_DAG_CONVERT_ERR,
    DAP_CHAIN_NODE_CLI_COM_DAG_PVT_KEY_ERR,
