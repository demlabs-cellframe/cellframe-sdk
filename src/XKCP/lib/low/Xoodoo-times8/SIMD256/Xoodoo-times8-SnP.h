...
#define Xoodootimes8_implementation        "256-bit SIMD implementation"
#define Xoodootimes8_statesSizeInBytes     (8*3*4*4)
#define Xoodootimes8_statesAlignment       32
...
void Xoodootimes8_PermuteAll_Nrounds(void *states, unsigned int nr);
