...
dap_chain_datum_tx_t *dap_ledger_test_create_stake_tx_cond(dap_enc_key_t *a_key_from, dap_chain_hash_fast_t *a_hash_prev, uint256_t a_value, dap_ledger_t *a_ledger) {
    ...
    dap_chain_tx_out_cond_t* l_tx_out_cond = dap_chain_datum_tx_item_out_cond_create_srv_stake_lock(l_uid, a_value, a_time_staking, uint256_0);
...
int dap_ledger_test_create_reward_decree(dap_ledger_t *a_ledger, dap_chain_t *a_chain, dap_chain_net_id_t a_net_id, uint256_t a_value, dap_cert_t *a_cert)
{
    // Create decree
...
//        l_offset += l_tsd_size_a;
        ...
        dap_assert_PIF(!dap_ledger_token_add(a_ledger, (byte_t *)l_decl, l_decl_size, 0),
...
void dap_ledger_test_run(void){
    ...
    dap_assert_PIF(dap_ledger_test_create_reward_decree(l_ledger, l_chain_main, l_net->pub.id, dap_chain_uint256_from(2), l_cert)==0, "Reward decree creating:");
    ...
    dap_assert_PIF(!dap_ledger_token_add(l_ledger, (byte_t *)l_token_decl, l_token_decl_size, 0), "Adding token declaration to ledger.");
    ...
    char *l_pass_msg = dap_strdup_printf("Starting balance is %s. Validation of the declaration of the token, "
                                         "creation of an emission and a basic transaction using it in the ledger", dap_uint256_to_const_char(l_balance, NULL));
    ...
    dap_assert_PIF(!dap_ledger_token_add(l_ledger, (byte_t *)l_token_decl_for_update, l_token_decl_for_update_size, 0), "Adding token declaration to ledger.");
    {
        ...
        dap_assert_PIF(
                dap_ledger_token_add(l_ledger, (byte_t *) l_token_upd_smaller_value, l_token_upd_smaller_value_size, 0),
    ...
    }
    {
        ...
        dap_assert_PIF(
                !dap_ledger_token_add(l_ledger, (byte_t *) l_token_upd_more_value, l_token_upd_more_value_size, 0),
    ...
    }
    {
        ...
        dap_assert_PIF(
                !dap_ledger_token_add(l_ledger, (byte_t *) l_token_upd_zero_value, l_token_upd_zero_value_size, 0),
